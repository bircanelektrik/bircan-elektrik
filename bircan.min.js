/* (c) 2026 Bircan Elektrik Muhendislik - Tum haklari saklidir */
...
kasa_yedek:1.05,
ortak_lamba_kat:2, ortak_giris:2, ortak_kablo_kat:18,
asansor_kw_kat:1.35, asansor_min_kesit:6, asansor_kablo_k:1.35,
...
var kolonSonuclar=[];
var maxKolonKesit=MLZ.kolon_min;
if(isBina) {
...
var kM=Math.round((ortaKat*MLZ.kat_h+MLZ.kolon_ek)*d.adet*MLZ.kolon_guzergah);
...
kolonSonuclar.push({tip:'Kolon',adet:1,kesit:kKesit.mm,damar:kolonDamar,metre:Math.round(kM*MLZ.kolon_guzergah),akim:dAkim});
}
var maxKolonAkimKap=0;
...
asanKuyu.kablo=Math.round((katSay*MLZ.kat_h+5)*MLZ.asansor_kablo_k);
}
var diyMalz=[];
...
else if(isBina) katEk=Math.ceil(katSay/2)*MLZ.kat_h;
...
var topKasa=Math.ceil((topPriz+topIslak+topAnahtar)*topDaire*MLZ.kasa_yedek);
...
var seritM=cevre+6;
var baglKabloM=Math.round(cevre*0.2)+katEkToprak+8;
