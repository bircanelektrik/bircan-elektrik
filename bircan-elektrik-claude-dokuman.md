...
## ACİL DÜZELTİLECEKLER — MALZEME ARACI v3

### 1. Müstakil/Villa'da ortak alan olmamalı
Müstakil ev ve villada ortak alan (merdiven aydınlatma, dakik anahtar vb.) hesaplanMAMALI. Ortak alan sadece apartman/bina seçildiğinde aktif olacak.

### 2. Kablo kesiti — minimum maliyet prensibi
Daire akımı eş zamanlı güç üzerinden belirlenir. Akıma ve gerilim düşümüne uygun **minimum** kesit seçilir. Fazla kesit = gereksiz maliyet.
- Kolon ve besleme hattı için minimum 6mm²
- 16A akım için 10mm² kablo fazladır → 6mm² yeterli
- NYY kapasite tablosunu düzelt: {mm:6,a:32} yerine gerçekçi minimum eşleştirme

### 3. Zayıf akım kabloları — BUAT OLMAZ
- RG6 ve CAT6 gibi zayıf akım kabloları müstakil ilerler, buat kullanılmaz
- Minimum zayıf akım hat başına 20m (tek kat daire için baz)
- Villa/bina'da her kat için kat metrajı eklenir
- Binada RG6'lar çatıya toplanır: 1. kat daire = 20m + şaft uzunluğu
- Formül: zayif_kablo = (nokta_sayisi × 20m) + (kat_no × kat_yuksekligi)

### 4. Kameralı diyafon — DT8 kablo YOK
- Kameralı sistemde DT8 kablo kullanılmaz
- Tamamen CAT6 / CAT5 tip kablolar kullanılır
- Besleme: 2×0.75 kablo (güç kaynağı beslemesi)
- Sesli ahize sistemde DT8 kalır

### 5. Besleme hattı kablo seçimi — 4 kombinasyon
| Seçim | Hat Tipi | Kablo |
|-------|---------|-------|
| Bakır + Havai | NYM (tek faz 2P, üç faz 4P) |
| Alüminyum + Havai | AER (Alpek) |
| Bakır + Yeraltı | NYY |
| Alüminyum + Yeraltı | NAYY |

NOT: İç kolon HER ZAMAN bakır NYY.

### 6. WhatsApp mesajı — tam detaylı liste
Mevcut kısa özet yetersiz. WhatsApp mesajında tüm malzeme listesi kalem kalem yazılmalı:
```
🏗️ *Malzeme Planlama — Detaylı Liste*
📊 *Genel Bilgi*
Kurulu güç: X kW
Eş zamanlı: X kW
Sistem: 3 Faz / Mono
...
(tüm kalemler devam eder)

⚠️ Tahmini listedir. Keşif için arayın.
```
